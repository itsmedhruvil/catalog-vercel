...
import { ArrowLeft, Bell, AlertCircle, CheckCircle, Clock, TrendingDown, Star, Calendar, Plus, Settings, Download, Filter } from "lucide-react";
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Monitor inventory levels and performance metrics</p>
              </div>
            </div>
